...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    fetch(`${BASE_URL}/global?populate=*`, {
      ...
      <div className="w-full py-12 md:py-section-padding px-4 md:px-margin-desktop grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-gutter max-w-container-max mx-auto">
        ...
        <div className="md:col-span-2 md:col-start-6 space-y-6">
          ...
          <ul className="space-y-3">
            ...
            <li><Link className="text-on-primary dark:text-on-surface-variant opacity-80 hover:opacity-100 hover:underline decoration-secondary-container decoration-2 underline-offset-4 transition-opacity font-label-md text-label-md" to="/">Dinas Komunikasi dan informatika Kabupaten Pekalongan</Link></li>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <ul className="space-y-3">
            <li><Link className="text-on-primary dark:text-on-surface-variant opacity-80 hover:opacity-100 hover:underline decoration-secondary-container decoration-2 underline-offset-4 transition-opacity font-label-md text-label-md" to="/unduhan">JDIH</Link></li>
            <li><Link className="text-on-primary dark:text-on-surface-variant opacity-80 hover:opacity-100 hover:underline decoration-secondary-container decoration-2 underline-offset-4 transition-opacity font-label-md text-label-md" to="/layanan">E-Government</Link></li>
        ...
        <div className="md:col-span-12 pt-8 md:pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 opacity-60">
            <Link className="font-label-sm text-label-sm hover:text-white" to="/profil">Kebijakan Privasi</Link>
            <Link className="font-label-sm text-label-sm hover:text-white" to="/layanan">Syarat &amp; Ketentuan</Link>
          </div>
        </div>
      </div>
    </footer>
