  ...
  return (
    <>
      ...
      <section className="relative h-[500px] md:h-[600px] overflow-hidden">
        <div className="absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000" style={{ backgroundImage: `url(${heroFallback})` }}>
        ...
        <div className="relative max-w-container-max mx-auto px-4 md:px-margin-desktop h-full flex flex-col justify-center items-start text-on-primary">
          <div className="max-w-2xl space-y-4 md:space-y-6">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4 pt-2 md:pt-4">
              <Link to="/layanan" className="bg-secondary-container text-on-secondary-container px-5 md:px-8 py-3 md:py-3.5 rounded-lg font-label-md text-label-md font-bold hover:scale-105 transition-transform shadow-lg">Lihat Layanan</Link>
              <Link to="/profil" className="bg-white/10 backdrop-blur-md border border-white/30 px-5 md:px-8 py-3 md:py-3.5 rounded-lg font-label-md text-label-md hover:bg-white/20 transition-all">Tentang Kami</Link>
            </div>
          </div>
        </div>
      ...
      <section className="relative -mt-10 md:-mt-16 z-10 max-w-container-max mx-auto px-4 md:px-margin-desktop">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-gutter">
          <Link className="bg-surface-white p-4 md:p-8 rounded-xl shadow-md flex flex-col items-center text-center hover-card group" to="/layanan">
          ...
          <Link className="bg-surface-white p-4 md:p-8 rounded-xl shadow-md flex flex-col items-center text-center hover-card group" to="/profil">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-primary-fixed mb-3 md:mb-4 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-on-primary transition-colors">
          ...
          <Link className="bg-surface-white p-4 md:p-8 rounded-xl shadow-md flex flex-col items-center text-center hover-card group" to="/unduhan">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-primary-fixed mb-3 md:mb-4 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-on-primary transition-colors">
      ...
      <section className="py-12 md:py-section-padding max-w-container-max mx-auto px-4 md:px-margin-desktop">
        <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-8 md:mb-12 gap-4">
          ...
          <Link className="text-primary font-label-md text-label-md flex items-center gap-2 hover:underline" to="/berita">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-gutter">
            {latestNews.map((article, idx) => {
              const imgUrl = article.featuredImage?.url
                ...
                : idx === 0
                ? 'https://lh3.googleusercontent.com/aida/AP1WRLutnS1yk1PDpdvJbCHW5w6vFZA00p_BbsnXoCGGuBlv9SWfYiJP10V5gO8huzcpzuSu-S30NBUrh4ml9rezuV2_Wt9_LMLCzLfaJkHKT6jJT5gLdn3RuRaGqtiwn9hjHbuZ6U5I0eDr0OVjaKckOQlmoQ3iJo9cSXRPOEanGikv65JWNi3N5akeI5f3qUBSTO5GShQKBjO22vShTZDYaKuwBiK0LrxN6OVhafT5ih8Zcw9ISl_fKkcf4g'
                : idx === 1
              ...
              return (
                <article key={article.documentId} className="bg-surface-white rounded-xl overflow-hidden shadow-sm hover-card border border-border-light flex flex-col">
                  ...
                  <div className="p-4 md:p-6 flex flex-col grow">
                    ...
                    <Link className="text-primary font-label-md text-label-md font-bold hover:gap-3 transition-all flex items-center gap-2 mt-auto" to={`/berita/${article.slug}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
            <div className="lg:col-span-2 space-y-6 md:space-y-8">
              <div className="flex items-center justify-between">
                ...
                <Link className="text-label-md font-label-md text-primary" to="/berita">Arsip Kabupaten</Link>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex gap-4 md:gap-6 bg-surface-white p-3 md:p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <Link className="text-primary-container font-label-sm text-label-sm mt-2 flex items-center gap-1 hover:underline" to="/berita">Selengkapnya <span className="material-symbols-outlined text-xs">open_in_new</span></Link>
                  </div>
                </div>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="bg-primary-container text-on-primary-container p-6 md:p-8 rounded-xl relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <Link className="inline-flex items-center gap-2 bg-surface-white text-primary px-6 py-2.5 rounded-lg font-label-md text-label-md hover:bg-secondary-container transition-colors" to="/kontak">Daftar Sekarang <span className="material-symbols-outlined">launch</span></Link>
                </div>
              </div>
              ...
              <div className="bg-surface-white p-4 md:p-6 rounded-xl border-l-4 border-secondary-container shadow-sm">
                ...
                <Link className="text-primary font-label-md text-label-md mt-4 inline-block hover:underline" to="/layanan">Isi Survei</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-container-max mx-auto px-4 md:px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex gap-4">
              <Link className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary-container hover:text-on-secondary-container transition-all" to="/berita" aria-label="Bagikan informasi">
